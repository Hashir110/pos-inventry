...
export default function SettingsPage() {
    ...
    useEffect(() => {
        ...
        if (savedPass) setDashboardPass(savedPass);
    }, []);

    const handleSavePassword = () => {
        if (!dashboardPass.trim()) {
            return toast.error("Password cannot be empty!");
        }

        // Save to Local Storage
        setDashboardPass("")
        localStorage.setItem("dashboardPass", dashboardPass);
            ...
            <div className="mb-6">
                ...
                <div className="relative">
                    <input
                        ...
                        className="w-full p-3 pr-20 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                        value={dashboardPass}
                    ...
                    <button
                        ...
                        className="absolute right-2 top-1.5 bottom-1.5 bg-gray-800 text-white text-xs px-4 rounded-md font-bold hover:bg-gray-900 transition-colors"
                    >
                        SAVE
                    </button>
                </div>
                ...
                <p className="text-[10px] text-gray-500 mt-1">
                    Ye password Sales aur Profit hide/show karne ke liye use hoga.
                </p>
            </div>
