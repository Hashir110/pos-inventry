                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-red-100 mt-0.5">
                                    {/* CASE 1: Abhi Din Baki Hain (-1, -2, -3) */}
                                    {daysOverdue < 0 && (
                                        <span>
                                            Apka license <b>{Math.abs(daysOverdue)} din mein expire</b> ho jayega. Service continue rakhne ke liye recharge karein.
                                        </span>
                                    )}

                                    {/* CASE 2: Aaj Expiry Hai (0) */}
                                    {daysOverdue === 0 && (
                                        <span>
                                            Apka license <b>AAJ expire ho raha hai</b>. Payment kardein werna system jald band hojayega.
                                        </span>
                                    )}

                                    {/* CASE 3: Din Guzar Gaye (1 Din) */}
                                    {daysOverdue > 0 && (
                                        <span>
                                            Package {daysOverdue} din pehle khatam hogya hai.
                                            System <b>{2 - daysOverdue} din</b> mein BLOCK hojayega.
                                        </span>
                                    )}
                                </p>
                            </div>
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
                                    ...
                                    <div>
                                        <p className="text-xs text-gray-500 uppercase font-bold">Easypaisa</p>
                                        <p className="text-lg font-bold text-gray-800">0309-0391673</p>
                                        <p className="text-xs text-gray-400">Title: Rizwan Ahmed</p>
                                    </div>
                                </div>
                            </div>
